...
public class AdvancePaymentDaoImpl implements AdvancePaymentDao {
	...
	public static final String GET_ADVANCE_PAYMENT = "select new com.monstarbill.finance.models.AdvancePayment(ap.id, ap.advanceAmount, ap.paymentAmount, ap.prePaymentNumber, ap.subsidiaryId, ap.supplierId, ap.prePaymentDate, ap.rejectedComments, ap.memo, ap.status, ap.unappliedAmount, "
			+ "	s.name as subsidiaryName, su.name as supplierName, ap.currency) "
